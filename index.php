...
<form action="newHero.php" method="post">
  ...
  <div class="form-group">
    ...
    <select multiple class="form-control" name="abilities" id="abilities">
        <?php
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" placeholder="A quick line to catch the attention of heroes, villains, and fans"></textarea>
  </div>
  <div class="form-group">
    <label for="newhero4">Bio</label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Tell us all about your origin story here"></textarea>
  </div>
